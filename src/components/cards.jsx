...
const cards = () => {
  return (
    <div className='cards bg-bgColor w-full py-36'>
       <div className='container mx-auto grid gap-5 items-center grid-cols-1 md:grid-cols-2'>
        <div className='z-10 flex items-center flex-col -mt-52'>
         ...
         <div className='z-10 h-full grid gap-5 grid-cols-1 md:grid-cols-2'>
             <div className='rounded-md h-52 bg-mainColor p-3 flex flex-col justify-center gap-y-2'>
             ...
             <div className='rounded-md h-52 bg-white p-3 flex flex-col justify-center gap-y-2'>
