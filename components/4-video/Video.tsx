    ...
    return (
        <div className="w-full">
            <div className='text-end px-10 space-y-5 my-12'>
                <h1 className="text-2xl md:text-4xl text-gray-800"><span className="text-indigo-500">Powerful Website At</span> The information Landing <br />  pages and <span className='text-indigo-500'>Blogging</span></h1>
